  ...
  return (
    <div className="container py-16">
      <div className="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
        {/* fast delivery */}
        <div className="border border-primary rounded-md hover:shadow-md hover:shadow-orange-200 transition duration-500 hover:cursor-pointer px-3 py-6 flex justify-center items-center gap-5">
          <Image
