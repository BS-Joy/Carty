...
const Footer2 = ({ lang }) => {
  return (
    <footer className="bg-white dark:bg-gray-900 border-t dark:border-none">
      <div className="mx-auto max-w-screen-2xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-8">
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-primary transition hover:text-dark dark:text-primary dark:hover:text-gray-300"
                >
        ...
        {/* <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <a
                className="inline-block text-teal-600 underline transition hover:text-teal-600/75 dark:text-primary dark:hover:text-gray-300"
                href="#"
              >
                Terms & Conditions
              </a>
